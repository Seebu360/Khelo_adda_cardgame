...
public class P_TableSettings : MonoBehaviour
{
    P_TableSettingClass ts = new P_TableSettingClass();
            ...
            case "back":
                {
                    if (P_InGameUiManager.instance != null)
                        P_InGameUiManager.instance.DestroyScreen(P_InGameScreens.TableSettings);
                }
                break;
            case "voicemsg":
                {
            ...
            case "vibration":
                {
                    ...
                    {
                        isvibrations = 0;
                        PlayerPrefs.SetString("isviberate", isvibrations.ToString());
                    ...
                    SoundManager.instance.ViberationCheck();
                }
                break;
            case "guesyournext":
                {
...
[System.Serializable]
public class P_TableSettingClass
{
